...
import com.googlecode.gwt.crypto.bouncycastle.util.encoders.Encoder;
...
public abstract class AbstractCoderTest extends CryptoTest
{
    ...
    private void checkOutputStreamDecode(byte[] original, byte[] encoded)
    {
        ...
        try
        {
            ...
            assertTrue(Arrays.areEqual(original, out.toByteArray()));
        }
        catch (IOException e)
        {
        ...
        throws IOException
    {
        ...
        assertTrue(Arrays.areEqual(original, bOut.toByteArray()));
    }
